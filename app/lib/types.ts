...
export type PartyState = { roomId: string; playback: PartyPlayback | null; participants: PartyParticipant[]; lastAction?: { type: string; seq: number } };
...
export type ApiStatus = { state: "idle" | "updating" | "updated" | "error"; at?: number };
