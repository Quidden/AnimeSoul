...
Актуальная реализация `app/`, версия **0.2.7**, схема **3**. Сверено с кодом **16 сентября 2026 года**. Английский — основной язык; русские пары имеют суффикс `.ru.md`. Пути в тексте относятся к корню репозитория, если не указано иначе.
