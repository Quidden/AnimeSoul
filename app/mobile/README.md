...
Мобильная версия основана на AnimeSoul 0.2.3 и запускает тот же React +
...
Для собственного плеера и загрузок, как и в 0.2.3 для Windows, пользователь
...
2. копирует backend 0.2.3 и локальный runtime;
