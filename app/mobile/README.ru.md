...
Мобильная версия основана на AnimeSoul 0.2.8 и запускает тот же React +
...
Для собственного плеера и загрузок, как и в 0.2.8 для Windows, пользователь
...
2. копирует backend 0.2.8 и локальный runtime;
...
ключа из переменных, описанных в [`UPDATE_SIGNING.md`](UPDATE_SIGNING.ru.md).
