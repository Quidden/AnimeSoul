...
- **Устройства в локальной сети:** явная привязка, автоматическая синхронизация сейвов параллельно с Google Drive, перенос скачанных MP4 и пульт с разрешениями и приоритетами. [Настройка и ограничения](app/docs/LAN_DEVICES.ru.md).
